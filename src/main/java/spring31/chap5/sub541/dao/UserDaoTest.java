...
public class UserDaoTest {
	...
	@Before
	public void setUp() {
		this.user1 = new User("gyumee", "name1", "springno1", Level.BASIC, 1, 0);
		this.user2 = new User("leegw700", "name2", "springno2", Level.SILVER, 55, 10);
		this.user3 = new User("bumjin", "name3", "springno3", Level.GOLD, 100, 40);
	}
